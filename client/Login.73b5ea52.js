...
exports.default = _default;
        var $d20404 = exports.default || module.exports;
      
      if (typeof $d20404 === 'function') {
        $d20404 = $d20404.options;
      }
    
        /* template */
        Object.assign($d20404, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d20404', $d20404);
          } else {
            api.reload('$d20404', $d20404);
          }
        }
...
//# sourceMappingURL=/Login.73b5ea52.map