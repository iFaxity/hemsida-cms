...
const Auth = {
  ...
  hasRole(key) {
    if (this.isLoggedIn) {
      ...
      return roles && roles.includes(key);
    }
...
function install(Vue, router, path = '/cms/auth') {
  ...
  install.installed = true;
  Auth.path = path; // Vue-router add meta authentication
...
exports.default = _default;
        var $f53afb = exports.default || module.exports;
      
      if (typeof $f53afb === 'function') {
        $f53afb = $f53afb.options;
      }
    
        /* template */
        Object.assign($f53afb, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f53afb', $f53afb);
          } else {
            api.reload('$f53afb', $f53afb);
          }
        }
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"lib/routes.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"_bundle_loader":"../node_modules/parcel-bundler/src/builtins/bundle-loader.js","../components/Dashboard.vue":[["Dashboard.6bb2be57.js","components/Dashboard.vue"],"Dashboard.6bb2be57.map","components/Dashboard.vue"],"../components/EditFields.vue":[["EditFields.db2187f8.js","components/EditFields.vue"],"EditFields.db2187f8.map","components/EditFields.vue"],"../components/EditPage.vue":[["EditPage.8c3362a0.js","components/EditPage.vue"],"EditPage.8c3362a0.map","components/EditPage.vue"],"../components/Layout.vue":[["Layout.42b12e09.js","components/Layout.vue"],"Layout.42b12e09.map","components/Layout.vue"],"../components/Login.vue":[["Login.73b5ea52.js","components/Login.vue"],"Login.73b5ea52.map","components/Login.vue"],"../components/Pages.vue":[["Pages.c0f6e4a4.js","components/Pages.vue"],"Pages.c0f6e4a4.map","components/Pages.vue"],"./auth":"lib/auth.js"}],"lib/snackbar.js":[function(require,module,exports) {
"use strict";
...
var _routes = _interopRequireDefault(require("./lib/routes"));
...
_vue.default.use(_api.default, "/cms/api");

_vue.default.use(_auth.default, Router, "/cms/auth"); // Title plugin
