...
},{"./modules/cms.tag":2,"./modules/ui":5,"riot":9}],2:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('cms', '<h3>{opts.title} - {opts.count}</h3> <form> <input ref="input" type="text" oninput="{onInput}"> <h3>Hello {greeting}</h3> </form> <ui-button basic icon="linkify">Hello mate</ui-button> <ui-segment> <ui-button>Click me</ui-button> </ui-segment>', 'cms,[data-is="cms"]{ margin-left: 16rem; display: block; } cms h3,[data-is="cms"] h3{ color: red; }', '', function(opts) {
    this.greeting = "Kek";
...
},{"riot":9}],3:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('ui-button', '<ui-icon if="{opts.icon}" icon="{opts.icon}"></ui-icon> <yield></yield>', '', 'class="{classes}" tabindex="{opts.tabindex}"', function(opts) {
    const {
...
},{"./util.js":8,"riot":9}],4:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('ui-icon', '', '', 'class="{classes}"', function(opts) {
    const {
      classify, useKey,
      useKeyOrValueAndKey
    } = require("./util");
...
},{"./util":8,"riot":9}],5:[function(require,module,exports){
module.exports = {
  menu: require("./menu.tag"),
  item: require("./item.tag"),
  icon: require("./icon.tag"),
  button: require("./button.tag")
  /*grid: require("./grid.tag"),
  segment: require("./segment.tag")*/
};


},{"./button.tag":3,"./icon.tag":4,"./item.tag":6,"./menu.tag":7}],6:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('ui-item', '<ui-icon if="{opts.icon}" icon="{opts.icon}"></ui-icon> <a if="{opts.href}" href="{opts.href}"><yield></yield></a> <yield if="{!opts.href}"></yield>', '', 'class="{classes}"', function(opts) {
    const {
      classify, useKey,
      useKeyOrValueAndKey
    } = require("./util");
...
},{"./util":8,"riot":9}],7:[function(require,module,exports){
var riot = require('riot');
...
},{"./util":8,"riot":9}],8:[function(require,module,exports){
